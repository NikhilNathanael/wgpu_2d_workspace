...
pub fn main () {
	...
	world.add_plugin(WindowPlugin::new("Test App", SHADER_DIRECTORY))
...
fn spawn_character (commands: Commands, renderer_2d: Res<Renderer2D>, context: Res<WGPUContext>, shader_manager: Res<ShaderManager>) {
